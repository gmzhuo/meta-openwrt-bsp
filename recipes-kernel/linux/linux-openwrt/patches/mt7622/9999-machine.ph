...
Index: kernel-source/arch/arm64/boot/dts/mediatek/Makefile
===================================================================
--- kernel-source.orig/arch/arm64/boot/dts/mediatek/Makefile
+++ kernel-source/arch/arm64/boot/dts/mediatek/Makefile
@@ -13,4 +13,4 @@
 dtb-$(CONFIG_ARCH_MEDIATEK) += mt8183-evb.dtb
 dtb-$(CONFIG_ARCH_MEDIATEK) += mt8183-kukui-krane-sku176.dtb
 dtb-$(CONFIG_ARCH_MEDIATEK) += mt8516-pumpkin.dtb
-dtb-y += mt7622-bananapi-bpi-r64.dtb
+dtb-y += mt7622-bananapi-bpi-r64.dtb mt7622-bananapi-bpi-r64-pcie1.dtbo mt7622-bananapi-bpi-r64-sata.dtbo
diff --git a/Makefile b/Makefile
index 4646baabfe78..d8e01e566188 100644
--- a/Makefile
+++ b/Makefile
...
index 50d580d77ae9..c6cb9a7e6ba3 100644
...
index 94133708889d..3c62e7670144 100644
...
+extra-$(CONFIG_OF_ALL_DTBS) += $(patsubst %.dtbo,%.dt.yaml, $(dtb-))
 ...
 # Add subdir path
@@ -325,6 +327,9 @@ cmd_dtc = $(HOSTCC) -E $(dtc_cpp_flags) -x assembler-with-cpp -o $(dtc-tmp) $< ;
...
--- /dev/null	2021-11-29 09:12:55.381130203 +0800
+++ b/scripts/dtc/fdtoverlay.c	2021-12-03 18:56:36.087956977 +0800
@@ -0,0 +1,208 @@
